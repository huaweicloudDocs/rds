...
3.  在左侧导航栏单击“备份管理”，选择需要恢复的备份，单击操作列的“恢复“。
    ...
    -   存在，继续[4](#li3991847815249)。
    -   不存在，跳过[4](#li3991847815249)，执行[5](#li5799021015249)。

4.  <a name="li3991847815249"></a>选择需要的恢复方式，单击“确定”。
    -   新实例
    ...
    -   当前实例
        ...
        在“实例管理”页面，可查看该实例状态为“恢复中”。无需执行[5](#li5799021015249)。
...
5.  <a name="li5799021015249"></a>恢复到新实例。
