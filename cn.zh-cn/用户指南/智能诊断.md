...
2.  对实例进行智能诊断。
    ...
    **方法一：**
    ...
    在“云DBA“页面，选择目标实例，单击对应操作列中的“智能诊断“，对您的实例进行全面诊断。

    **图 1**  方法一<a name="fig6457219122711"></a>  
    ![](figures/方法一.png "方法一")
    ...
    **方法三：**
    ...
    2.  在左侧导航栏选择“云DBA“，在“智能诊断“页签下单击“智能诊断“，对您的实例进行全面诊断。
        ...
        **图 3**  方法三<a name="fig532617565542"></a>  
        ![](figures/方法三.png "方法三")


    **方法四：**

    1.  在“云DBA“页面，选择目标实例，单击实例名称，进入实例的“基本信息“页签。
    2.  在左侧导航栏选择“云DBA“，在“智能诊断“页签下单击“智能诊断“，对您的实例进行全面诊断。
...
3.  在“智能诊断“页签，对实例进行诊断时，您可以根据需要选择诊断指标。
    ...
    -   如果选择了部分或全部诊断指标，单击“智能诊断“，云DBA仅对您选择的指标进行诊断。
        ...
        **图 4**  智能诊断<a name="fig746021415211"></a>  
    ...
    **表 1**  诊断指标
    ...
    <td class="cellrowborder" valign="top" width="17.44%" headers="mcps1.2.7.1.2 "><p id="p0623193271711"><a name="p0623193271711"></a><a name="p0623193271711"></a>自增检查</p>
    <p id="p1923754075216"><a name="p1923754075216"></a><a name="p1923754075216"></a>引擎检查</p>
    ...
    <td class="cellrowborder" valign="top" width="16.73%" headers="mcps1.2.7.1.3 "><p id="p8647653101916"><a name="p8647653101916"></a><a name="p8647653101916"></a>自增检查</p>
    <p id="p176477533195"><a name="p176477533195"></a><a name="p176477533195"></a>引擎检查</p>
    ...
    <td class="cellrowborder" valign="top" width="15.49%" headers="mcps1.2.7.1.6 "><p id="p8896104682310"><a name="p8896104682310"></a><a name="p8896104682310"></a>自增检查</p>
    <p id="p791074615237"><a name="p791074615237"></a><a name="p791074615237"></a>引擎检查</p>
...
4.  在“智能诊断“页签，如果需要自定义设置诊断指标的阈值，您可以单击“诊断设置“，在弹出框中进行设置。
    ...
    **图 5**  阈值设置<a name="fig10400730185618"></a>  
    ...
    **表 2**  阈值设置
    ...
    <tr id="row11136349164611"><td class="cellrowborder" valign="top" width="6.6293370662933695%" headers="mcps1.2.8.1.1 "><p id="p15136949154620"><a name="p15136949154620"></a><a name="p15136949154620"></a>16</p>
    </td>
...
5.  在“智能诊断“页签，如果您需要诊断实例在某一历史时间点的运行状况，勾选“指定诊断时间“前面的复选框，单击![](figures/时间选择框.png)选择历史时间点，对该时间点的实例数据进行诊断。
    ...
    **图 6**  指定诊断时间<a name="fig37916123316"></a>  
