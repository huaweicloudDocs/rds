# 查询自动备份策略（v3）<a name="rds_09_0003"></a>
...
-   要素说明
    ...
    **表 2**  要素说明
    ...
    <td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p42890904"><a name="p42890904"></a><a name="p42890904"></a>字典数据结构，请参见<a href="#rds_09_0003__table163715367507">表3</a></p>
    </td>
