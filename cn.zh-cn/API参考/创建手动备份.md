...
-   参数说明
    ...
    **表 2**  参数说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="p1423120591112"><a name="p1423120591112"></a><a name="p1423120591112"></a>列表数据结构，请参见<a href="#table917312715167">表3</a></p>
    </td>
...
-   要素说明
    ...
    **表 4**  要素说明
    ...
    <td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p082633632010"><a name="p082633632010"></a><a name="p082633632010"></a>字典数据结构，请参见<a href="#table153397472217">表5</a></p>
    </td>
    ...
    **表 5**  backup字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p113646472216"><a name="p113646472216"></a><a name="p113646472216"></a>字典数据结构，请参见<a href="#table917312715167">表3</a></p>
    </td>
