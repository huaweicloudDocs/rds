# 根据指定条件查询数据库实例列表<a name="rds_01_0004"></a>
...
-   要素说明
    ...
    **表 3**  instances字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25.25%" headers="mcps1.2.4.1.2 "><p id="p19127583260"><a name="p19127583260"></a><a name="p19127583260"></a>字典数据结构</p>
    </td>
    ...
    <p id="p146713272134"><a name="p146713272134"></a><a name="p146713272134"></a>详情请请参见<a href="#table14771167122611">表6</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="25.25%" headers="mcps1.2.4.1.2 "><p id="p1112713817269"><a name="p1112713817269"></a><a name="p1112713817269"></a>字典数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="25.25%" headers="mcps1.2.4.1.2 "><p id="p212818182615"><a name="p212818182615"></a><a name="p212818182615"></a>列表数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="25.25%" headers="mcps1.2.4.1.2 "><p id="p1412818122617"><a name="p1412818122617"></a><a name="p1412818122617"></a>列表数据结构</p>
    </td>
