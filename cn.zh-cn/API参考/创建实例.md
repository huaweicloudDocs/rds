...
-   参数说明
    ...
    **表 2**  参数说明
    ...
    <div class="notice" id="note629684781753"><a name="note629684781753"></a><a name="note629684781753"></a><span class="noticetitle"> 须知： </span><div class="noticebody"><p id="p298453971753"><a name="p298453971753"></a><a name="p298453971753"></a>Microsoft SQL Server不支持创建只读副本。</p>
    </div></div>
    </td>
    </tr>
    </tbody>
    ...
    **表 3**  instance字段数据结构说明（创建单实例和HA实例）
    ...
    <table><thead align="left"><tr id="row61525259"><th class="cellrowborder" valign="top" width="20.71%" id="mcps1.2.5.1.1"><p id="p17490046"><a name="p17490046"></a><a name="p17490046"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="11.940000000000001%" id="mcps1.2.5.1.2"><p id="p7407659"><a name="p7407659"></a><a name="p7407659"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="30.11%" id="mcps1.2.5.1.3"><p id="p63149496"><a name="p63149496"></a><a name="p63149496"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="37.24%" id="mcps1.2.5.1.4"><p id="p14835533"><a name="p14835533"></a><a name="p14835533"></a>说明</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row60827539"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p28083633"><a name="p28083633"></a><a name="p28083633"></a>name</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p60181840"><a name="p60181840"></a><a name="p60181840"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p42890904"><a name="p42890904"></a><a name="p42890904"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p23411412333"><a name="p23411412333"></a><a name="p23411412333"></a>实例名称。</p>
    <p id="p885418445352"><a name="p885418445352"></a><a name="p885418445352"></a>用于表示实例的名称，同一租户下，同类型的实例名可重名，其中，SQL Server实例名唯一。</p>
    ...
    <tr id="row56760689"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p34213098"><a name="p34213098"></a><a name="p34213098"></a>datastore</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p19797588"><a name="p19797588"></a><a name="p19797588"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p60100823"><a name="p60100823"></a><a name="p60100823"></a>字典数据结构，请参见<a href="#table64243102">表5</a>。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p58520811"><a name="p58520811"></a><a name="p58520811"></a>数据库信息。</p>
    </td>
    </tr>
    <tr id="row42565233"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p25231885"><a name="p25231885"></a><a name="p25231885"></a>flavorRef</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p30516772"><a name="p30516772"></a><a name="p30516772"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p55939488"><a name="p55939488"></a><a name="p55939488"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p34804713"><a name="p34804713"></a><a name="p34804713"></a>规格ID，获取方法可参考<a href="获取所有实例规格信息.md">获取所有实例规格信息</a>的响应消息中的<span class="parmname" id="parmname138834265715"><a name="parmname138834265715"></a><a name="parmname138834265715"></a>“flavors.id”</span>。</p>
    ...
    <tr id="row49370368"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p39576862"><a name="p39576862"></a><a name="p39576862"></a>volume</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p51609257"><a name="p51609257"></a><a name="p51609257"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p19600264"><a name="p19600264"></a><a name="p19600264"></a>字典数据结构，请参见<a href="#table10656503">表6</a>。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p61513540"><a name="p61513540"></a><a name="p61513540"></a>volume信息。</p>
    </td>
    </tr>
    <tr id="row16540805"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p64736823"><a name="p64736823"></a><a name="p64736823"></a>region</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p9191297"><a name="p9191297"></a><a name="p9191297"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p6297612"><a name="p6297612"></a><a name="p6297612"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p40344576"><a name="p40344576"></a><a name="p40344576"></a>区域ID。</p>
    ...
    <tr id="row9307971"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p15748167"><a name="p15748167"></a><a name="p15748167"></a>availabilityZone</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p533144"><a name="p533144"></a><a name="p533144"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p43184669"><a name="p43184669"></a><a name="p43184669"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p8297278"><a name="p8297278"></a><a name="p8297278"></a>可用区ID。</p>
    ...
    <tr id="row51313205"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p62728917"><a name="p62728917"></a><a name="p62728917"></a>vpc</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p47877526"><a name="p47877526"></a><a name="p47877526"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p52874399"><a name="p52874399"></a><a name="p52874399"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p54967961"><a name="p54967961"></a><a name="p54967961"></a>虚拟私有云ID。获取方法请参见《虚拟私有云API参考》中“VPC”的内容。</p>
    ...
    <tr id="row15861880"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p9743886"><a name="p9743886"></a><a name="p9743886"></a>nics</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p51057338"><a name="p51057338"></a><a name="p51057338"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p42003681"><a name="p42003681"></a><a name="p42003681"></a>字典数据结构，请参见<a href="#table2179128">表7</a>。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p19042013"><a name="p19042013"></a><a name="p19042013"></a>nics信息。获取方法请参见《虚拟私有云API参考》中“子网”的内容。</p>
    </td>
    </tr>
    <tr id="row66008059"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p45052529"><a name="p45052529"></a><a name="p45052529"></a>securityGroup</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p25376232"><a name="p25376232"></a><a name="p25376232"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p42208903"><a name="p42208903"></a><a name="p42208903"></a>字典数据结构，请参见<a href="#table4150710">表8</a>。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p34431157"><a name="p34431157"></a><a name="p34431157"></a>指定实例所属的安全组。</p>
    <p id="p41444960"><a name="p41444960"></a><a name="p41444960"></a>获取方法请参见《虚拟私有云API参考》中“安全组”的内容。</p>
    </td>
    </tr>
    <tr id="row31320691125738"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p9447096125742"><a name="p9447096125742"></a><a name="p9447096125742"></a>dbPort</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p27017325125742"><a name="p27017325125742"></a><a name="p27017325125742"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p40919702125742"><a name="p40919702125742"></a><a name="p40919702125742"></a>Int。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p19914101012135"><a name="p19914101012135"></a><a name="p19914101012135"></a>数据库端口信息。</p>
    ...
    <tr id="row37460321"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p14387121"><a name="p14387121"></a><a name="p14387121"></a>backupStrategy</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p24506125"><a name="p24506125"></a><a name="p24506125"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p38839134"><a name="p38839134"></a><a name="p38839134"></a>字典数据结构，请参见<a href="#table49774232">表9</a>。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p60897649"><a name="p60897649"></a><a name="p60897649"></a>高级备份策略。</p>
    </td>
    </tr>
    <tr id="row33762549"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p50411912"><a name="p50411912"></a><a name="p50411912"></a>dbRtPd</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p56833109"><a name="p56833109"></a><a name="p56833109"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p40079106"><a name="p40079106"></a><a name="p40079106"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p25182135"><a name="p25182135"></a><a name="p25182135"></a>数据库root密码。</p>
    ...
    <tr id="row48829755"><td class="cellrowborder" valign="top" width="20.71%" headers="mcps1.2.5.1.1 "><p id="p62896114"><a name="p62896114"></a><a name="p62896114"></a>ha</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.940000000000001%" headers="mcps1.2.5.1.2 "><p id="p61420436"><a name="p61420436"></a><a name="p61420436"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="30.11%" headers="mcps1.2.5.1.3 "><p id="p8999435"><a name="p8999435"></a><a name="p8999435"></a>字典数据结构，请参见<a href="#table622861661833">表10</a>。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.24%" headers="mcps1.2.5.1.4 "><p id="p51028923"><a name="p51028923"></a><a name="p51028923"></a>HA配置参数，创建HA实例时使用。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 4**  instance字段数据结构说明（创建只读副本）
    ...
    <table><thead align="left"><tr id="row70524471753"><th class="cellrowborder" valign="top" width="21.51%" id="mcps1.2.5.1.1"><p id="p343772981753"><a name="p343772981753"></a><a name="p343772981753"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="11.559999999999999%" id="mcps1.2.5.1.2"><p id="p330977911753"><a name="p330977911753"></a><a name="p330977911753"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="29.29%" id="mcps1.2.5.1.3"><p id="p636754041753"><a name="p636754041753"></a><a name="p636754041753"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="37.64%" id="mcps1.2.5.1.4"><p id="p574340811753"><a name="p574340811753"></a><a name="p574340811753"></a>说明</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row216489991753"><td class="cellrowborder" valign="top" width="21.51%" headers="mcps1.2.5.1.1 "><p id="p87385011753"><a name="p87385011753"></a><a name="p87385011753"></a>name</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.559999999999999%" headers="mcps1.2.5.1.2 "><p id="p367300201753"><a name="p367300201753"></a><a name="p367300201753"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.29%" headers="mcps1.2.5.1.3 "><p id="p223416761753"><a name="p223416761753"></a><a name="p223416761753"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.64%" headers="mcps1.2.5.1.4 "><p id="p181181003619"><a name="p181181003619"></a><a name="p181181003619"></a>实例名称。</p>
    ...
    <tr id="row363844211753"><td class="cellrowborder" valign="top" width="21.51%" headers="mcps1.2.5.1.1 "><p id="p614570251753"><a name="p614570251753"></a><a name="p614570251753"></a>flavorRef</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.559999999999999%" headers="mcps1.2.5.1.2 "><p id="p119630961753"><a name="p119630961753"></a><a name="p119630961753"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.29%" headers="mcps1.2.5.1.3 "><p id="p294867401753"><a name="p294867401753"></a><a name="p294867401753"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.64%" headers="mcps1.2.5.1.4 "><p id="p396157731753"><a name="p396157731753"></a><a name="p396157731753"></a>规格ID，获取方法可参考<a href="获取所有实例规格信息.md">获取所有实例规格信息</a>的响应消息中的<span class="parmname" id="parmname12572271810"><a name="parmname12572271810"></a><a name="parmname12572271810"></a>“flavors.id”</span>。</p>
    ...
    <tr id="row260045131753"><td class="cellrowborder" valign="top" width="21.51%" headers="mcps1.2.5.1.1 "><p id="p259908001753"><a name="p259908001753"></a><a name="p259908001753"></a>replicaOf</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.559999999999999%" headers="mcps1.2.5.1.2 "><p id="p248800801753"><a name="p248800801753"></a><a name="p248800801753"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.29%" headers="mcps1.2.5.1.3 "><p id="p20206171753"><a name="p20206171753"></a><a name="p20206171753"></a>String。</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.64%" headers="mcps1.2.5.1.4 "><p id="p294522581753"><a name="p294522581753"></a><a name="p294522581753"></a>只读副本配置参数。为replicaOf值指定的主实例创建只读副本。</p>
    ...
    **表 5**  datastore字段数据结构说明
    ...
    <table><thead align="left"><tr id="row4043462"><th class="cellrowborder" valign="top" width="21.05%" id="mcps1.2.5.1.1"><p id="p59085005"><a name="p59085005"></a><a name="p59085005"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="11.899999999999999%" id="mcps1.2.5.1.2"><p id="p21156092"><a name="p21156092"></a><a name="p21156092"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="29.409999999999997%" id="mcps1.2.5.1.3"><p id="p35921916"><a name="p35921916"></a><a name="p35921916"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="37.64%" id="mcps1.2.5.1.4"><p id="p23994101"><a name="p23994101"></a><a name="p23994101"></a>说明</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row64473998"><td class="cellrowborder" valign="top" width="21.05%" headers="mcps1.2.5.1.1 "><p id="p55011311"><a name="p55011311"></a><a name="p55011311"></a>type</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.899999999999999%" headers="mcps1.2.5.1.2 "><p id="p26731201"><a name="p26731201"></a><a name="p26731201"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.409999999999997%" headers="mcps1.2.5.1.3 "><p id="p17743659"><a name="p17743659"></a><a name="p17743659"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.64%" headers="mcps1.2.5.1.4 "><p id="p49175803141056"><a name="p49175803141056"></a><a name="p49175803141056"></a>数据库引擎，目前支持引擎如下：</p>
    <a name="ul924933143511"></a><a name="ul924933143511"></a><ul id="ul924933143511"><li>MySQL</li><li>PostgreSQL</li><li>SQLServer</li></ul>
    </td>
    </tr>
    <tr id="row40466701"><td class="cellrowborder" valign="top" width="21.05%" headers="mcps1.2.5.1.1 "><p id="p56577386"><a name="p56577386"></a><a name="p56577386"></a>version</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.899999999999999%" headers="mcps1.2.5.1.2 "><p id="p19365543"><a name="p19365543"></a><a name="p19365543"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.409999999999997%" headers="mcps1.2.5.1.3 "><p id="p25105132"><a name="p25105132"></a><a name="p25105132"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.64%" headers="mcps1.2.5.1.4 "><p id="p20249826"><a name="p20249826"></a><a name="p20249826"></a>数据库版本。</p>
    <a name="ul2128855618558"></a><a name="ul2128855618558"></a><ul id="ul2128855618558"><li>MySQL引擎支持5.6、5.7版本。取值示例：5.7。</li><li>PostgreSQL引擎支持9.5、9.6、10、11版本。取值示例：9.6。</li><li>Microsoft SQL Server引擎支持2014 SE、2014 EE、2016 SE、2016 EE、2008 R2 EE、2008 R2 WEB、2014 WEB、2016 WEB版本。取值示例：2008_R2_EE。</li></ul>
    ...
    **表 6**  volume字段数据结构说明
    ...
    <table><thead align="left"><tr id="row5847780"><th class="cellrowborder" valign="top" width="21.51%" id="mcps1.2.5.1.1"><p id="p3908185"><a name="p3908185"></a><a name="p3908185"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="11.67%" id="mcps1.2.5.1.2"><p id="p48127554"><a name="p48127554"></a><a name="p48127554"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="29.29%" id="mcps1.2.5.1.3"><p id="p6017800"><a name="p6017800"></a><a name="p6017800"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="37.53%" id="mcps1.2.5.1.4"><p id="p17679762"><a name="p17679762"></a><a name="p17679762"></a>说明</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="row22774600"><td class="cellrowborder" valign="top" width="21.51%" headers="mcps1.2.5.1.1 "><p id="p32803348"><a name="p32803348"></a><a name="p32803348"></a>type</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.67%" headers="mcps1.2.5.1.2 "><p id="p39825499"><a name="p39825499"></a><a name="p39825499"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.29%" headers="mcps1.2.5.1.3 "><p id="p4640007"><a name="p4640007"></a><a name="p4640007"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.53%" headers="mcps1.2.5.1.4 "><p id="p40296320"><a name="p40296320"></a><a name="p40296320"></a>磁盘类型。</p>
    ...
    <tr id="row42343927"><td class="cellrowborder" valign="top" width="21.51%" headers="mcps1.2.5.1.1 "><p id="p7306053"><a name="p7306053"></a><a name="p7306053"></a>size</p>
    </td>
    <td class="cellrowborder" valign="top" width="11.67%" headers="mcps1.2.5.1.2 "><p id="p54919424"><a name="p54919424"></a><a name="p54919424"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.29%" headers="mcps1.2.5.1.3 "><p id="p19288335"><a name="p19288335"></a><a name="p19288335"></a>Int</p>
    </td>
    <td class="cellrowborder" valign="top" width="37.53%" headers="mcps1.2.5.1.4 "><p id="p18851291"><a name="p18851291"></a><a name="p18851291"></a>磁盘大小。</p>
    <p id="p1878135135412"><a name="p1878135135412"></a><a name="p1878135135412"></a>取值范围：40GB~4000GB。必须为10的整数倍。</p>
    <p id="p8725181468"><a name="p8725181468"></a><a name="p8725181468"></a>MySQL部分用户支持11GB~10000GB，如果您想创建存储空间最大为10000GB的数据库实例，或提高扩容上限到10000GB，请联系客服开通。</p>
    ...
    **表 7**  nics字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p40261524"><a name="p40261524"></a><a name="p40261524"></a>子网的网络ID信息：从VPC获取。</p>
    ...
    **表 9**  backupStrategy字段数据结构说明
    ...
    <p id="p5563313"><a name="p5563313"></a><a name="p5563313"></a>取值范围：0～732。该参数缺省，或取0值，表示不设置自动备份策略。如果需要延长保留时间请联系客服人员申请，自动备份最长可以保留2562天。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   要素说明
    ...
    **表 12**  instance字段数据结构说明
    ...
    <tr id="row42592467"><td class="cellrowborder" valign="top" width="26.36263626362636%" headers="mcps1.2.4.1.1 "><p id="p27437792"><a name="p27437792"></a><a name="p27437792"></a>hostname</p>
    </td>
    ...
    **表 13**  nics字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p14932534165139"><a name="p14932534165139"></a><a name="p14932534165139"></a>子网的网络ID信息</p>
    </td>
    </tr>
    </tbody>
    </table>
