# 删除数据库实例<a name="rds_01_0003"></a>

## 功能介绍<a name="section4284989"></a>

删除数据库实例，不支持删除包周期实例。

对于包年包月的主实例和只读实例，您需要进行订单退订才可删除实例，详细操作请参见[退订包周期实例](https://support.huaweicloud.com/usermanual-rds/rds_05_0056.html)。
...
-   URI样例
    ...
    https://rds.cn-north-1.myhuaweicloud.com/v3/0483b6b16e954cb88930a360d2c4e663/instances/dsfae23fsfdsae3435in01
