...
-   参数说明
    ...
    **表 2**  参数说明（创建Ha实例和单实例）
    ...
    <th class="cellrowborder" valign="top" width="7.360896445131375%" id="mcps1.2.5.1.2"><p id="p7407659"><a name="p7407659"></a><a name="p7407659"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="16.68276661514683%" id="mcps1.2.5.1.3"><p id="p63149496"><a name="p63149496"></a><a name="p63149496"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="52.47295208655331%" id="mcps1.2.5.1.4"><p id="p14835533"><a name="p14835533"></a><a name="p14835533"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p60181840"><a name="p60181840"></a><a name="p60181840"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p42890904"><a name="p42890904"></a><a name="p42890904"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p51611184"><a name="p51611184"></a><a name="p51611184"></a>实例名称。用于表示实例的名称，同一租户下，同类型的实例名唯一。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p19797588"><a name="p19797588"></a><a name="p19797588"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p60100823"><a name="p60100823"></a><a name="p60100823"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p58520811"><a name="p58520811"></a><a name="p58520811"></a>数据库信息。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p1249795916511"><a name="p1249795916511"></a><a name="p1249795916511"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p175034591153"><a name="p175034591153"></a><a name="p175034591153"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p1851455914518"><a name="p1851455914518"></a><a name="p1851455914518"></a>HA配置参数，创建HA实例时使用。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p93315541168"><a name="p93315541168"></a><a name="p93315541168"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p173313549619"><a name="p173313549619"></a><a name="p173313549619"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p53312541067"><a name="p53312541067"></a><a name="p53312541067"></a>参数组ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p69131102134"><a name="p69131102134"></a><a name="p69131102134"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p6913210191313"><a name="p6913210191313"></a><a name="p6913210191313"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p19914101012135"><a name="p19914101012135"></a><a name="p19914101012135"></a>数据库端口信息。</p>
    ...
    <a name="ul1696512278148"></a><a name="ul1696512278148"></a><ul id="ul1696512278148"><li>MySQL默认<span>3306</span>。</li><li>PostgreSQL默认<span>5432</span>。</li><li>Microsoft SQL Server默认1433。</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p6522163210139"><a name="p6522163210139"></a><a name="p6522163210139"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p1352217328132"><a name="p1352217328132"></a><a name="p1352217328132"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p252314328139"><a name="p252314328139"></a><a name="p252314328139"></a>数据库密码。</p>
    ...
    <tr id="row1531134871717"><td class="cellrowborder" valign="top" width="23.483384853168467%" headers="mcps1.2.5.1.1 "><p id="p169876381815"><a name="p169876381815"></a><a name="p169876381815"></a>backup_strategy</p>
    </td>
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p9987103141817"><a name="p9987103141817"></a><a name="p9987103141817"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p198712311185"><a name="p198712311185"></a><a name="p198712311185"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p14803115432218"><a name="p14803115432218"></a><a name="p14803115432218"></a>高级备份策略。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p11777144416184"><a name="p11777144416184"></a><a name="p11777144416184"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p877715445182"><a name="p877715445182"></a><a name="p877715445182"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p877711445181"><a name="p877711445181"></a><a name="p877711445181"></a>企业项目ID。</p>
    <p id="p64311017163313"><a name="p64311017163313"></a><a name="p64311017163313"></a>使用请参考《<span>企业管理</span> API参考》的“<a href="https://support.huaweicloud.com/api-em/zh-cn_topic_0121230880.html" target="_blank" rel="noopener noreferrer">查询企业项目列表</a>”响应消息表<span class="parmname" id="parmname2073619533913"><a name="parmname2073619533913"></a><a name="parmname2073619533913"></a>“enterprise_project字段数据结构说明”</span>的“<span>id</span>”。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p206971718181915"><a name="p206971718181915"></a><a name="p206971718181915"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p14699618121914"><a name="p14699618121914"></a><a name="p14699618121914"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p1669991812194"><a name="p1669991812194"></a><a name="p1669991812194"></a>用于磁盘加密的密钥ID，默认为空。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p30516772"><a name="p30516772"></a><a name="p30516772"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p55939488"><a name="p55939488"></a><a name="p55939488"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p11524913121019"><a name="p11524913121019"></a><a name="p11524913121019"></a>规格码，取值范围：非空。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p51609257"><a name="p51609257"></a><a name="p51609257"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p19600264"><a name="p19600264"></a><a name="p19600264"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p61513540"><a name="p61513540"></a><a name="p61513540"></a>volume信息。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p9191297"><a name="p9191297"></a><a name="p9191297"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p6297612"><a name="p6297612"></a><a name="p6297612"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p40344576"><a name="p40344576"></a><a name="p40344576"></a>区域ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p533144"><a name="p533144"></a><a name="p533144"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p43184669"><a name="p43184669"></a><a name="p43184669"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p8297278"><a name="p8297278"></a><a name="p8297278"></a>可用区ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p47877526"><a name="p47877526"></a><a name="p47877526"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p52874399"><a name="p52874399"></a><a name="p52874399"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p54967961"><a name="p54967961"></a><a name="p54967961"></a>虚拟私有云ID。获取方法请参见《虚拟私有云API参考》中“VPC”的内容。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p51057338"><a name="p51057338"></a><a name="p51057338"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p42003681"><a name="p42003681"></a><a name="p42003681"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p19042013"><a name="p19042013"></a><a name="p19042013"></a>子网信息。获取方法请参见《虚拟私有云API参考》中“子网”的内容。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p25376232"><a name="p25376232"></a><a name="p25376232"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p42208903"><a name="p42208903"></a><a name="p42208903"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p34431157"><a name="p34431157"></a><a name="p34431157"></a>指定实例所属的安全组。获取方法请参见《虚拟私有云API参考》中“安全组”的内容。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="7.360896445131375%" headers="mcps1.2.5.1.2 "><p id="p18093019918"><a name="p18093019918"></a><a name="p18093019918"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.68276661514683%" headers="mcps1.2.5.1.3 "><p id="p1501930098"><a name="p1501930098"></a><a name="p1501930098"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.47295208655331%" headers="mcps1.2.5.1.4 "><p id="p180153019913"><a name="p180153019913"></a><a name="p180153019913"></a>创建类型信息，支持包年包月和按需，默认为按需。</p>
    ...
    **表 3**  参数说明（创建只读实例，SQL Server暂不支持通过API创建只读）
    ...
    <p id="p18982199191310"><a name="p18982199191310"></a><a name="p18982199191310"></a>只读实例的磁盘容量必须大于等于主实例的磁盘容量。</p>
    ...
    **表 4**  datastore字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="52.67027863777089%" headers="mcps1.2.5.1.4 "><p id="p49175803141056"><a name="p49175803141056"></a><a name="p49175803141056"></a>数据库引擎，取值如下：</p>
    ...
    **表 7**  volume字段数据结构说明
    ...
    <th class="cellrowborder" valign="top" width="6.5129293708992675%" id="mcps1.2.5.1.2"><p id="p48127554"><a name="p48127554"></a><a name="p48127554"></a>是否必选</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="6.5129293708992675%" headers="mcps1.2.5.1.2 "><p id="p39825499"><a name="p39825499"></a><a name="p39825499"></a>是</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="6.5129293708992675%" headers="mcps1.2.5.1.2 "><p id="p54919424"><a name="p54919424"></a><a name="p54919424"></a>是</p>
    </td>
    ...
    <div class="notice" id="note18772920133413"><a name="note18772920133413"></a><a name="note18772920133413"></a><span class="noticetitle"> 注意： </span><div class="noticebody"><p id="p3772920183420"><a name="p3772920183420"></a><a name="p3772920183420"></a>只读实例磁盘大小必须大于或等于主实例的磁盘大小。</p>
    </div></div>
    </td>
    </tr>
    </tbody>
