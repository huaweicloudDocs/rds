...
-   参数说明
    ...
    **表 2**  参数说明（创建Ha实例和单实例）
    ...
    <th class="cellrowborder" valign="top" width="8.133693972179287%" id="mcps1.2.5.1.2"><p id="p7407659"><a name="p7407659"></a><a name="p7407659"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="16.0645285935085%" id="mcps1.2.5.1.3"><p id="p63149496"><a name="p63149496"></a><a name="p63149496"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="53.09119010819165%" id="mcps1.2.5.1.4"><p id="p14835533"><a name="p14835533"></a><a name="p14835533"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p60181840"><a name="p60181840"></a><a name="p60181840"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p42890904"><a name="p42890904"></a><a name="p42890904"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p51611184"><a name="p51611184"></a><a name="p51611184"></a>实例名称。用于表示实例的名称，同一租户下，同类型的实例名唯一。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p19797588"><a name="p19797588"></a><a name="p19797588"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p60100823"><a name="p60100823"></a><a name="p60100823"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p58520811"><a name="p58520811"></a><a name="p58520811"></a>数据库信息。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p1249795916511"><a name="p1249795916511"></a><a name="p1249795916511"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p175034591153"><a name="p175034591153"></a><a name="p175034591153"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p1851455914518"><a name="p1851455914518"></a><a name="p1851455914518"></a>HA配置参数，创建HA实例时使用。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p93315541168"><a name="p93315541168"></a><a name="p93315541168"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p173313549619"><a name="p173313549619"></a><a name="p173313549619"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p53312541067"><a name="p53312541067"></a><a name="p53312541067"></a>参数组ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p69131102134"><a name="p69131102134"></a><a name="p69131102134"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p6913210191313"><a name="p6913210191313"></a><a name="p6913210191313"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p19914101012135"><a name="p19914101012135"></a><a name="p19914101012135"></a>数据库端口信息。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p6522163210139"><a name="p6522163210139"></a><a name="p6522163210139"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p1352217328132"><a name="p1352217328132"></a><a name="p1352217328132"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p252314328139"><a name="p252314328139"></a><a name="p252314328139"></a>数据库密码。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p9987103141817"><a name="p9987103141817"></a><a name="p9987103141817"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p198712311185"><a name="p198712311185"></a><a name="p198712311185"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p14803115432218"><a name="p14803115432218"></a><a name="p14803115432218"></a>高级备份策略。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p11777144416184"><a name="p11777144416184"></a><a name="p11777144416184"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p877715445182"><a name="p877715445182"></a><a name="p877715445182"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p877711445181"><a name="p877711445181"></a><a name="p877711445181"></a>企业项目ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p206971718181915"><a name="p206971718181915"></a><a name="p206971718181915"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p14699618121914"><a name="p14699618121914"></a><a name="p14699618121914"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p1669991812194"><a name="p1669991812194"></a><a name="p1669991812194"></a>用于磁盘加密的密钥ID，默认为空。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p30516772"><a name="p30516772"></a><a name="p30516772"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p55939488"><a name="p55939488"></a><a name="p55939488"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p11524913121019"><a name="p11524913121019"></a><a name="p11524913121019"></a>规格码，取值范围：非空。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p51609257"><a name="p51609257"></a><a name="p51609257"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p19600264"><a name="p19600264"></a><a name="p19600264"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p61513540"><a name="p61513540"></a><a name="p61513540"></a>volume信息。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p9191297"><a name="p9191297"></a><a name="p9191297"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p6297612"><a name="p6297612"></a><a name="p6297612"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p40344576"><a name="p40344576"></a><a name="p40344576"></a>区域ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p533144"><a name="p533144"></a><a name="p533144"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p43184669"><a name="p43184669"></a><a name="p43184669"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p8297278"><a name="p8297278"></a><a name="p8297278"></a>可用区ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p47877526"><a name="p47877526"></a><a name="p47877526"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p52874399"><a name="p52874399"></a><a name="p52874399"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p54967961"><a name="p54967961"></a><a name="p54967961"></a>虚拟私有云ID。获取方法请参见《虚拟私有云API参考》中“VPC”的内容。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p51057338"><a name="p51057338"></a><a name="p51057338"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p42003681"><a name="p42003681"></a><a name="p42003681"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p19042013"><a name="p19042013"></a><a name="p19042013"></a>子网信息。获取方法请参见《虚拟私有云API参考》中“子网”的内容。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p25376232"><a name="p25376232"></a><a name="p25376232"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p42208903"><a name="p42208903"></a><a name="p42208903"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p34431157"><a name="p34431157"></a><a name="p34431157"></a>指定实例所属的安全组。获取方法请参见《虚拟私有云API参考》中“安全组”的内容。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p18093019918"><a name="p18093019918"></a><a name="p18093019918"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p1501930098"><a name="p1501930098"></a><a name="p1501930098"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p180153019913"><a name="p180153019913"></a><a name="p180153019913"></a>创建类型信息，支持包年包月和按需，默认为按需。</p>
    ...
    <td class="cellrowborder" valign="top" width="8.133693972179287%" headers="mcps1.2.5.1.2 "><p id="p89781877410"><a name="p89781877410"></a><a name="p89781877410"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.0645285935085%" headers="mcps1.2.5.1.3 "><p id="p1256350411"><a name="p1256350411"></a><a name="p1256350411"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="53.09119010819165%" headers="mcps1.2.5.1.4 "><p id="p68612171854"><a name="p68612171854"></a><a name="p68612171854"></a>UTC时区。</p>
    ...
    **表 3**  参数说明（创建只读实例，SQL Server暂不支持通过API创建只读）
    ...
    <td class="cellrowborder" valign="top" width="51.902779122688095%" headers="mcps1.2.5.1.4 "><p id="p16732178121218"><a name="p16732178121218"></a><a name="p16732178121218"></a>实例名称。用于表示实例的名称，同一租户下，同类型的实例名唯一。</p>
    ...
    <p id="p48851020185819"><a name="p48851020185819"></a><a name="p48851020185819"></a>使用可参考<a href="根据指定条件查询数据库实例列表.md">根据指定条件查询数据库实例列表</a>响应消息<a href="根据指定条件查询数据库实例列表.md#table2058713718267">表3</a>中的<span class="parmname" id="parmname1453564418011"><a name="parmname1453564418011"></a><a name="parmname1453564418011"></a>“id”</span>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="17.02333688389658%" headers="mcps1.2.5.1.3 "><p id="p2276149171212"><a name="p2276149171212"></a><a name="p2276149171212"></a>字典数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="51.902779122688095%" headers="mcps1.2.5.1.4 "><p id="p1833589161210"><a name="p1833589161210"></a><a name="p1833589161210"></a>区域ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="17.02333688389658%" headers="mcps1.2.5.1.3 "><p id="p1340202717107"><a name="p1340202717107"></a><a name="p1340202717107"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.902779122688095%" headers="mcps1.2.5.1.4 "><p id="p19402192710107"><a name="p19402192710107"></a><a name="p19402192710107"></a>创建类型信息，支持包年/包月和按需，默认为按需。</p>
    ...
    **表 4**  datastore字段数据结构说明
    ...
    <a name="ul2128855618558"></a><a name="ul2128855618558"></a><ul id="ul2128855618558"><li>MySQL引擎支持5.6、5.7版本。取值示例：5.7。</li><li>PostgreSQL引擎支持9.5、9.6版本。取值示例：9.6。</li><li>Microsoft SQL Server：仅支持2014 SE、2014 EE、2016 SE、2016 EE、2008 R2 EE、2008 R2 WEB、2014 WEB、2016 WEB。取值示例2014_SE。</li></ul>
    ...
    **表 5**  ha字段数据结构说明
    ...
    <th class="cellrowborder" valign="top" width="15.518407575611171%" id="mcps1.2.5.1.3"><p id="p83297567293"><a name="p83297567293"></a><a name="p83297567293"></a>参数类型</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="15.518407575611171%" headers="mcps1.2.5.1.3 "><p id="p15376756162917"><a name="p15376756162917"></a><a name="p15376756162917"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="15.518407575611171%" headers="mcps1.2.5.1.3 "><p id="p1721540173210"><a name="p1721540173210"></a><a name="p1721540173210"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.7780461880375%" headers="mcps1.2.5.1.4 "><p id="p15585263415"><a name="p15585263415"></a><a name="p15585263415"></a>备机同步参数。实例主备模式为Ha时有效。</p>
    ...
    **表 7**  volume字段数据结构说明
    ...
    <table><thead align="left"><tr id="row5847780"><th class="cellrowborder" valign="top" width="25.14473176379776%" id="mcps1.2.5.1.1"><p id="p3908185"><a name="p3908185"></a><a name="p3908185"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="7.400617522192205%" id="mcps1.2.5.1.2"><p id="p48127554"><a name="p48127554"></a><a name="p48127554"></a>是否必选</p>
    </th>
    ...
    <tbody><tr id="row22774600"><td class="cellrowborder" valign="top" width="25.14473176379776%" headers="mcps1.2.5.1.1 "><p id="p32803348"><a name="p32803348"></a><a name="p32803348"></a>type</p>
    </td>
    <td class="cellrowborder" valign="top" width="7.400617522192205%" headers="mcps1.2.5.1.2 "><p id="p39825499"><a name="p39825499"></a><a name="p39825499"></a>是</p>
    </td>
    ...
    <tr id="row42343927"><td class="cellrowborder" valign="top" width="25.14473176379776%" headers="mcps1.2.5.1.1 "><p id="p7306053"><a name="p7306053"></a><a name="p7306053"></a>size</p>
    </td>
    <td class="cellrowborder" valign="top" width="7.400617522192205%" headers="mcps1.2.5.1.2 "><p id="p54919424"><a name="p54919424"></a><a name="p54919424"></a>是</p>
    </td>
    <td class="cellrowborder" valign="top" width="15.41875723658819%" headers="mcps1.2.5.1.3 "><p id="p19288335"><a name="p19288335"></a><a name="p19288335"></a>Int</p>
    </td>
    ...
    **表 8**  chargeInfo字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="6.56624179219776%" headers="mcps1.2.5.1.2 "><p id="p20705135015261"><a name="p20705135015261"></a><a name="p20705135015261"></a>否</p>
    </td>
...
-   要素说明
    ...
    **表 9**  要素说明
    ...
    <td class="cellrowborder" valign="top" width="40.29%" headers="mcps1.2.4.1.2 "><p id="p1907972"><a name="p1907972"></a><a name="p1907972"></a>字典数据结构</p>
    </td>
    ...
    **表 10**  instance说明
    ...
    <th class="cellrowborder" valign="top" width="40.46404640464046%" id="mcps1.2.4.1.2"><p id="p1280910568278"><a name="p1280910568278"></a><a name="p1280910568278"></a>参数类型</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p14953885305"><a name="p14953885305"></a><a name="p14953885305"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p48498568273"><a name="p48498568273"></a><a name="p48498568273"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p4861203433016"><a name="p4861203433016"></a><a name="p4861203433016"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p88941566271"><a name="p88941566271"></a><a name="p88941566271"></a>字典数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p89401656112716"><a name="p89401656112716"></a><a name="p89401656112716"></a>字典数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p1697725682718"><a name="p1697725682718"></a><a name="p1697725682718"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p1923157132717"><a name="p1923157132717"></a><a name="p1923157132717"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p101421957152719"><a name="p101421957152719"></a><a name="p101421957152719"></a>字典数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p161842577271"><a name="p161842577271"></a><a name="p161842577271"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p2219205782710"><a name="p2219205782710"></a><a name="p2219205782710"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p12250057172719"><a name="p12250057172719"></a><a name="p12250057172719"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p162993579272"><a name="p162993579272"></a><a name="p162993579272"></a>字典数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p83409571274"><a name="p83409571274"></a><a name="p83409571274"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p7431165752717"><a name="p7431165752717"></a><a name="p7431165752717"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p1522205719275"><a name="p1522205719275"></a><a name="p1522205719275"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p20568457112711"><a name="p20568457112711"></a><a name="p20568457112711"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p9603205716276"><a name="p9603205716276"></a><a name="p9603205716276"></a>String</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="40.46404640464046%" headers="mcps1.2.4.1.2 "><p id="p4202165993417"><a name="p4202165993417"></a><a name="p4202165993417"></a>字典数据结构</p>
    </td>
    ...
    **表 11**  datastore字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="44.4%" headers="mcps1.2.5.1.4 "><p id="p1734174217233"><a name="p1734174217233"></a><a name="p1734174217233"></a>数据库引擎，返回值如下：</p>
    ...
    **表 13**  backupStrategy字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p16242373370"><a name="p16242373370"></a><a name="p16242373370"></a>备份时间段。自动备份将在该时间段内触发。</p>
    ...
    **表 14**  volume字段数据结构说明
    ...
    <a name="ul1289061112301"></a><a name="ul1289061112301"></a><ul id="ul1289061112301"><li>COMMON，表示SATA。</li><li>HIGH，表示SAS。</li><li>ULTRAHIGH，表示SSD。</li></ul>
    </td>
    </tr>
