...
-   参数说明
    ...
    **表 2**  参数说明（创建Ha实例和单实例）
    ...
    <td class="cellrowborder" valign="top" width="36.5340030911901%" headers="mcps1.2.5.1.4 "><p id="p8297278"><a name="p8297278"></a><a name="p8297278"></a>可用区ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="7.602395672333848%" headers="mcps1.2.5.1.2 "><p id="p51057338"><a name="p51057338"></a><a name="p51057338"></a>是</p>
    </td>
    ...
    **表 3**  参数说明（创建只读实例，SQL Server暂不支持通过API创建只读）
    ...
    <td class="cellrowborder" valign="top" width="34.734191924082495%" headers="mcps1.2.5.1.4 "><p id="p1136159181211"><a name="p1136159181211"></a><a name="p1136159181211"></a>实例ID，用于创建只读实例。</p>
    ...
    <td class="cellrowborder" valign="top" width="34.734191924082495%" headers="mcps1.2.5.1.4 "><p id="p743712961216"><a name="p743712961216"></a><a name="p743712961216"></a>可用区ID。</p>
...
-   要素说明
    ...
    **表 10**  instance说明
    ...
    <td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p64207592918"><a name="p64207592918"></a><a name="p64207592918"></a>实例ID，用于创建只读实例。</p>
    </td>
    </tr>
