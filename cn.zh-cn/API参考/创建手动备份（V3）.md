...
-   参数说明
    ...
    **表 2**  参数说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="p1423120591112"><a name="p1423120591112"></a><a name="p1423120591112"></a>字典数据结构，请参见<a href="#table917312715167">表3</a></p>
    </td>
