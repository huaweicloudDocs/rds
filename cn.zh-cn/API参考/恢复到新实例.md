...
-   参数说明
    ...
    **表 2**  参数说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p1669991812194"><a name="p1669991812194"></a><a name="p1669991812194"></a>用于磁盘加密的密钥ID，默认为空。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p11524913121019"><a name="p11524913121019"></a><a name="p11524913121019"></a>规格码，取值范围：非空,。</p>
    <p id="p1778193619122"><a name="p1778193619122"></a><a name="p1778193619122"></a>使用可参考<a href="查询数据库规格.md">查询数据库规格</a>的响应消息中的<span class="parmname" id="parmname775383513104"><a name="parmname775383513104"></a><a name="parmname775383513104"></a>“spec_code”</span>。</p>
    </td>
    </tr>
    ...
    **表 3**  ha字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.2 "><p id="p336525662915"><a name="p336525662915"></a><a name="p336525662915"></a>是</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p16181542163018"><a name="p16181542163018"></a><a name="p16181542163018"></a>实例主备模式，取值：Ha（主备），不区分大小写。</p>
    </td>
    </tr>
    ...
    **表 4**  backup\_strategy字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p20642173819393"><a name="p20642173819393"></a><a name="p20642173819393"></a>备份时间段。自动备份将在该时间段内触发。</p>
    ...
    **表 6**  restore\_point字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.2 "><p id="p65301153103119"><a name="p65301153103119"></a><a name="p65301153103119"></a>是</p>
    </td>
...
-   要素说明
    ...
    **表 8**  instance说明
    ...
    <table><thead align="left"><tr id="row4782256142718"><th class="cellrowborder" valign="top" width="33.36333633363336%" id="mcps1.2.4.1.1"><p id="p11791105616272"><a name="p11791105616272"></a><a name="p11791105616272"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="33.3033303330333%" id="mcps1.2.4.1.2"><p id="p1280910568278"><a name="p1280910568278"></a><a name="p1280910568278"></a>参数类型</p>
    </th>
    ...
    <td class="cellrowborder" valign="top" width="33.3033303330333%" headers="mcps1.2.4.1.2 "><p id="p88941566271"><a name="p88941566271"></a><a name="p88941566271"></a>字典数据结构，请参见<a href="#table766045720277">表9</a></p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="33.3033303330333%" headers="mcps1.2.4.1.2 "><p id="p89401656112716"><a name="p89401656112716"></a><a name="p89401656112716"></a>字典数据结构，请参见<a href="#table15899105722713">表10</a></p>
    </td>
    ...
    <tr id="row83725720277"><td class="cellrowborder" valign="top" width="33.36333633363336%" headers="mcps1.2.4.1.1 "><p id="p1743125712278"><a name="p1743125712278"></a><a name="p1743125712278"></a>password</p>
    </td>
    <td class="cellrowborder" valign="top" width="33.3033303330333%" headers="mcps1.2.4.1.2 "><p id="p116185712711"><a name="p116185712711"></a><a name="p116185712711"></a>String。</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="33.3033303330333%" headers="mcps1.2.4.1.2 "><p id="p101421957152719"><a name="p101421957152719"></a><a name="p101421957152719"></a>字典数据结构，请参见<a href="#table81249589270">表11</a></p>
    </td>
    ...
    <tr id="row915625718272"><td class="cellrowborder" valign="top" width="33.36333633363336%" headers="mcps1.2.4.1.1 "><p id="p916345732711"><a name="p916345732711"></a><a name="p916345732711"></a>enterprise_project_tag</p>
    </td>
    <td class="cellrowborder" valign="top" width="33.3033303330333%" headers="mcps1.2.4.1.2 "><p id="p161842577271"><a name="p161842577271"></a><a name="p161842577271"></a>String。</p>
    </td>
    ...
    <tr id="row11961857142710"><td class="cellrowborder" valign="top" width="33.36333633363336%" headers="mcps1.2.4.1.1 "><p id="p420435702717"><a name="p420435702717"></a><a name="p420435702717"></a>disk_encryption_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="33.3033303330333%" headers="mcps1.2.4.1.2 "><p id="p2219205782710"><a name="p2219205782710"></a><a name="p2219205782710"></a>String。</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p2146115915716"><a name="p2146115915716"></a><a name="p2146115915716"></a>规格ID。</p>
    ...
    <td class="cellrowborder" valign="top" width="33.3033303330333%" headers="mcps1.2.4.1.2 "><p id="p162993579272"><a name="p162993579272"></a><a name="p162993579272"></a>字典数据结构，请参见<a href="#table5324165817272">表12</a></p>
    </td>
    ...
    **表 10**  ha字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p4997155711270"><a name="p4997155711270"></a><a name="p4997155711270"></a>实例主备模式，取值：Ha（主备）。</p>
    </td>
    </tr>
    ...
    **表 11**  backupStrategy字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p54551583414"><a name="p54551583414"></a><a name="p54551583414"></a>备份时间段。自动备份将在该时间段内触发。</p>
