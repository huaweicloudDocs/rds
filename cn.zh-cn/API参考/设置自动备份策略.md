...
-   参数说明
    ...
    **表 2**  参数说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="p42890904"><a name="p42890904"></a><a name="p42890904"></a>字典数据结构，请参见<a href="#table163715367507">表3</a></p>
    </td>
    ...
    **表 3**  backup\_policy字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p11638173615018"><a name="p11638173615018"></a><a name="p11638173615018"></a>备份周期配置。自动备份将在每星期指定的天进行。除关闭自动备份策略外，必选。</p>
