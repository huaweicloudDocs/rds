...
-   要素说明
    ...
    **表 3**  要素说明
    ...
    <td class="cellrowborder" valign="top" width="30%" headers="mcps1.2.4.1.2 "><p id="p12825171522"><a name="p12825171522"></a><a name="p12825171522"></a>字典数据结构，请参见<a href="#table4062895917262">表4</a>。</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="30%" headers="mcps1.2.4.1.2 "><p id="p828117481940"><a name="p828117481940"></a><a name="p828117481940"></a>字典数据结构，请参见<a href="#table1014617554138">表5</a>、<a href="#table7391102412203">表8</a>、<a href="#table148754542012">表10</a>、 <a href="#table2098817407217">表11</a>。</p>
    </td>
    ...
    **表 5**  entities字段数据结构说明\(创建实例，单转主备，创建只读实例\)
    ...
    <td class="cellrowborder" valign="top" width="32%" headers="mcps1.2.4.1.2 "><p id="p01623557138"><a name="p01623557138"></a><a name="p01623557138"></a>字典数据结构，请参见<a href="#table975183423611">表6</a>。</p>
    </td>
    ...
    **表 6**  entities.instance字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="29.7029702970297%" headers="mcps1.2.4.1.2 "><p id="p156507445552"><a name="p156507445552"></a><a name="p156507445552"></a>字典数据结构，请参见<a href="#table173094268581">表7</a>。</p>
    </td>
    ...
    **表 8**  entities字段数据结构说明\(调整实例容量\)
    ...
    <td class="cellrowborder" valign="top" width="31.36686331366863%" headers="mcps1.2.4.1.2 "><p id="p10405142432016"><a name="p10405142432016"></a><a name="p10405142432016"></a>字典数据结构，请参见<a href="#table624912591398">表9</a>。</p>
    </td>
