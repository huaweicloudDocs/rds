...
-   要素说明
    ...
    **表 3**  要素说明
    ...
    <td class="cellrowborder" valign="top" width="50.07%" headers="mcps1.2.4.1.2 "><p id="p28299952183823"><a name="p28299952183823"></a><a name="p28299952183823"></a>列表数据结构，请参见<a href="#table66531170">表4 errorLogList字段数据结构说明</a>。</p>
    </td>
