...
-   参数说明
    ...
    **表 1**  参数说明
    ...
    <td class="cellrowborder" valign="top" width="59%" headers="mcps1.2.5.1.4 "><p id="p7738172511118"><a name="p7738172511118"></a><a name="p7738172511118"></a>子网的网络ID信息。</p>
...
-   正常响应要素说明
    ...
    **表 4**  instances字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="51.519999999999996%" headers="mcps1.2.4.1.3 "><p id="p1512628132610"><a name="p1512628132610"></a><a name="p1512628132610"></a>子网的网络ID信息。</p>
    </td>
    </tr>
