...
-   URI样例
    ...
    https://rds.cn-north-1.myhuaweicloud.com/v3/0483b6b16e954cb88930a360d2c4e663/configurations/463b4b58-d0e8-4e2b-9560-5dea4552fde9/apply
...
-   参数说明
    ...
    **表 1**  参数说明
    ...
    <p id="p1955917142067"><a name="p1955917142067"></a><a name="p1955917142067"></a>获取方法请参见<a href="获取项目ID.md">获取项目ID</a>。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="64.64999999999999%" headers="mcps1.2.4.1.3 "><p id="p77882015143610"><a name="p77882015143610"></a><a name="p77882015143610"></a>参数模板ID。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
## 请求消息<a name="section15386150366"></a>
...
## 响应消息<a name="section8569161515366"></a>
...
-   正常响应要素说明
    ...
    **表 3**  要素说明
    ...
    <td class="cellrowborder" valign="top" width="33.67%" headers="mcps1.2.4.1.3 "><p id="p8788151563617"><a name="p8788151563617"></a><a name="p8788151563617"></a>参数模板ID。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="33.67%" headers="mcps1.2.4.1.3 "><p id="p19788815123616"><a name="p19788815123616"></a><a name="p19788815123616"></a>参数模板名称</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="33.67%" headers="mcps1.2.4.1.3 "><p id="p20788181510366"><a name="p20788181510366"></a><a name="p20788181510366"></a>参数模板应用具体结果。</p>
    ...
    <td class="cellrowborder" valign="top" width="33.67%" headers="mcps1.2.4.1.3 "><p id="p14788181583618"><a name="p14788181583618"></a><a name="p14788181583618"></a>参数模板是否都应用成功。</p>
    <a name="ul07881715103618"></a><a name="ul07881715103618"></a><ul id="ul07881715103618"><li><span class="parmvalue" id="parmvalue144461220183113"><a name="parmvalue144461220183113"></a><a name="parmvalue144461220183113"></a>“true”</span>表示参数模板都应用成功。</li><li><span class="parmvalue" id="parmvalue8230132315317"><a name="parmvalue8230132315317"></a><a name="parmvalue8230132315317"></a>“false”</span>表示存在应用失败的参数模板。</li></ul>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 4**  apply\_results字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="35.4035403540354%" headers="mcps1.2.4.1.3 "><p id="p680412152366"><a name="p680412152366"></a><a name="p680412152366"></a>参数模板是否应用成功。</p>
