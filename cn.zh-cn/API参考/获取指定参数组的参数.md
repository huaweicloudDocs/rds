...
-   要素说明
    ...
    **表 2**  要素说明
    ...
    <p id="p5133143114"><a name="p5133143114"></a><a name="p5133143114"></a>其中，T<span>指某个时间的开始；</span>Z指时区偏移量，例如北京时间偏移显示为+0800。</p>
    </td>
    </tr>
    ...
    <p id="p211831173119"><a name="p211831173119"></a><a name="p211831173119"></a>其中，T<span>指某个时间的开始；</span>Z指时区偏移量，例如北京时间偏移显示为+0800。</p>
    </td>
    </tr>
