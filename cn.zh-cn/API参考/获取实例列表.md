...
-   参数说明
    ...
    **表 1**  参数说明
    ...
    <tbody><tr id="row3953622317262"><td class="cellrowborder" valign="top" width="22.21%" headers="mcps1.2.4.1.1 "><p id="p4831745717262"><a name="p4831745717262"></a><a name="p4831745717262"></a>project_id</p>
    </td>
...
-   要素说明
    ...
    **表 3**  instances字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="45.1054894510549%" headers="mcps1.2.4.1.3 "><p id="p7417132564016"><a name="p7417132564016"></a><a name="p7417132564016"></a>实例主节点ID。</p>
    ...
    **表 4**  nics字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="53.64%" headers="mcps1.2.4.1.3 "><p id="p43983303175250"><a name="p43983303175250"></a><a name="p43983303175250"></a>子网的网络ID信息</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 9**  backupStrategy字段数据结构说明
    ...
    <p id="p263511174811"><a name="p263511174811"></a><a name="p263511174811"></a>取值范围：0～732。为0时，表示未设置自动备份策略。如果需要延长保留时间请联系客服人员申请，自动备份最长可以保留2562天。</p>
    </td>
    </tr>
    </tbody>
    </table>
