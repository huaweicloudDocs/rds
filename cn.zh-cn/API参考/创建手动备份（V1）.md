...
-   要素说明
    ...
    **表 6**  backup字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p60052454181146"><a name="p60052454181146"></a><a name="p60052454181146"></a><span>Backup描述。</span></p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p61887659174428"><a name="p61887659174428"></a><a name="p61887659174428"></a><span>Backup的UUID。</span></p>
    </td>
    </tr>
